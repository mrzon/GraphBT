	...
	public void setValue(String value, IDirectEditingContext context) {
		...
		if(object instanceof Component) {
			...
			if(GraphBTUtil.getComponent(getModel(), value)==null) {
				Component cp = GraphBTUtil.getBEFactory().createComponent();
		...
		//if the direct-edited object is and instance of traceability link
			...
			if(!(GraphBTUtil.getRequirement(getDiagram(), value) == null)) {
				requirements = GraphBTUtil.getBEFactory().createRequirement();
				requirements.setRequirement(value);
				getModel().getRequirementList().getRequirements().add(requirements);
			}
			else{
				requirements = GraphBTUtil.getRequirement(getDiagram(), value);
			}
