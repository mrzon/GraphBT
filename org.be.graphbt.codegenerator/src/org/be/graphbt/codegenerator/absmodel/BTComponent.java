...
public class BTComponent {
	...
	public Set<ABSVariable> collectABSVariables(ABSModule module) {
		if(!isPrimitive()&&!isData()&&!getName().equalsIgnoreCase("List")&&!getName().equalsIgnoreCase("SET")) {   
			...
			ABSMethod pressMethod = new ABSMethod(ABSDataType.UNIT,"press",new ArrayList<ABSParameter>());
			ABSMethod isPressedMethod = new ABSMethod(ABSDataType.BOOL,"isPressed",new ArrayList<ABSParameter>());
			ABSMethod releaseMethod = new ABSMethod(ABSDataType.UNIT,"release",new ArrayList<ABSParameter>());
			ABSMethod isReleasedMethod = new ABSMethod(ABSDataType.BOOL,"isReleased",new ArrayList<ABSParameter>());
			...
			ABSMethodImplementation pressImplementation = new ABSMethodImplementation(pressMethod);
			ABSMethodImplementation isPressedImplementation = new ABSMethodImplementation(isPressedMethod);
			ABSMethodImplementation releaseImplementation = new ABSMethodImplementation(releaseMethod);
			ABSMethodImplementation isReleasedImplementation = new ABSMethodImplementation(isReleasedMethod);
			...
			ac.addMethodImplementation(pressImplementation);
			ac.addMethodImplementation(isPressedImplementation);
			ac.addMethodImplementation(releaseImplementation);
			ac.addMethodImplementation(isReleasedImplementation);
			...
			ABSVariable press = new ABSVariable(ABSDataType.BOOL, "press");
			ac.addVariable(press);
			press.setValue("False");
			ABSVariable release = new ABSVariable(ABSDataType.BOOL, "release");
			ac.addVariable(release);
			...
			pressImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "press = True"));
			isPressedImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "Bool temp = press"));
			isPressedImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "press = False"));
			isPressedImplementation.addStatement(new ABSStatement(ABSStatementType.RETURN, "return temp"));

			releaseImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "release = True"));
			isReleasedImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "Bool temp = release"));
			isReleasedImplementation.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "release = False"));
			isReleasedImplementation.addStatement(new ABSStatement(ABSStatementType.RETURN, "return temp"));
			...
			for(int i = 0; i < behaviorList.size(); i++) {
				...
				if(b.getType()==BTType.STATE) {
					...
					String n = b.getName().toLowerCase();
					if(this.getRef().startsWith("CBUTTON")) {
						if(b.getName().equalsIgnoreCase("clicked")) {
						...
						if(b.getName().equalsIgnoreCase("pressed")) {
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "Bool temp = this.isPressed()"));
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "block = not(temp)"));
						}
						if(b.getName().equalsIgnoreCase("released")) {
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "Bool temp = this.isReleased()"));
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "block = not(temp)"));
						}
					}
						...
						if(!this.boolVar.contains(aa[1].trim())) {
							...
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "Bool temp = "+stat));
							//                            _ABSWhile aw = new _ABSWhile(new _ABSCondition(""+stat+""));
							//                            absMI.addStatement(aw);
							//                            aw.addStatement(new ABSStatement(ABSStatementType.ADDON,"suspend"));
							absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT, "block = temp"));
						}
					}
					else {
						String aa = n;
					...
					absMI.addStatement(new ABSStatement(ABSStatementType.ASSIGNMENT,"block=False"));
				}
