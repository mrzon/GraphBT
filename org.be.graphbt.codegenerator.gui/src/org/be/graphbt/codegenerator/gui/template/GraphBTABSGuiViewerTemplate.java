...
public class GraphBTABSGuiViewerTemplate
{
  ...
  protected final String TEXT_8 = " = new Image(d.display, new FileInputStream(file";
  protected final String TEXT_9 = "));" + NL + "\t\t";
  protected final String TEXT_10 = NL + "\t\tfinal Button button";
  protected final String TEXT_11 = " = new Button(d.composite, SWT.NULL);" + NL + "\t\td.widgets.put(\"";
  ...
  protected final String TEXT_21 = ".addSelectionListener(new SelectionAdapter() {" + NL + "\t\t\tpublic void widgetSelected(SelectionEvent event) {" + NL + "\t\t\t\tABSFut<Component_i> f = d.async_getComponent(abs.backend.java.lib.types.ABSString.fromString(\"";
  protected final String TEXT_22 = "\"));" + NL + "\t\t\t\tComponent_i component = null;" + NL + "\t\t\t\twhile(!f.isResolved()) {" + NL + "\t\t\t\t\tif(f.isResolved()) {" + NL + "\t\t\t\t\t\tcomponent = f.getValue();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(component!=null)" + NL + "\t\t\t\t\tcomponent.async_click();" + NL + "\t\t\t}" + NL + "\t\t});" + NL + "\t\t";
  protected final String TEXT_23 = NL + "\t\tfinal Label label";
  protected final String TEXT_24 = " = new Label(d.composite, SWT.NULL);" + NL + "\t\td.widgets.put(\"";
  ...
  protected final String TEXT_34 = NL + "\t\td.composite.pack();" + NL + "\t\td.shell.open();" + NL + "\t\twhile(!d.shell.isDisposed()) {" + NL + "\t\t\tif(!d.display.readAndDispatch()) {" + NL + "\t\t\t\td.display.sleep();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + " \t\td.display.dispose();" + NL + " \t} catch (Exception e) {" + NL + " \t}" + NL + "\t\t" + NL + "\t \treturn ABSUnit.UNIT;" + NL + " \t}" + NL + " }" + NL;
