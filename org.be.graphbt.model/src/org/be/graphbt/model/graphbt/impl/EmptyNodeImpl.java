 ...
 * <ul>
 *   <li>{@link org.be.graphbt.model.graphbt.impl.EmptyNodeImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmptyNodeImpl extends NodeImpl implements EmptyNode {
	...
	protected EClass eStaticClass() {
		return GraphBTPackage.Literals.EMPTY_NODE;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphBTPackage.EMPTY_NODE__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphBTPackage.EMPTY_NODE__LABEL:
				return getLabel();
		}
