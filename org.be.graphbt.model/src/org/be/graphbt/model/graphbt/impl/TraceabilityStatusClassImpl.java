 ...
 * <ul>
 *   <li>{@link org.be.graphbt.model.graphbt.impl.TraceabilityStatusClassImpl#getTraceabilityStatusLiteral <em>Traceability Status Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TraceabilityStatusClassImpl extends EObjectImpl implements TraceabilityStatusClass {
	...
	protected EClass eStaticClass() {
		return GraphBTPackage.Literals.TRACEABILITY_STATUS_CLASS;
	}
	...
	public void setTraceabilityStatusLiteral(String newTraceabilityStatusLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphBTPackage.TRACEABILITY_STATUS_CLASS__TRACEABILITY_STATUS_LITERAL, oldTraceabilityStatusLiteral, traceabilityStatusLiteral));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphBTPackage.TRACEABILITY_STATUS_CLASS__TRACEABILITY_STATUS_LITERAL:
