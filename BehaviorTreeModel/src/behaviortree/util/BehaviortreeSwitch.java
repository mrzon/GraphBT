...
public class BehaviortreeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BehaviortreePackage.BE_MODEL: {
			...
			case BehaviortreePackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviortreePackage.SPECIAL_EDGE: {
				SpecialEdge specialEdge = (SpecialEdge)theEObject;
				T result = caseSpecialEdge(specialEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviortreePackage.EMPTY_NODE: {
			...
			case BehaviortreePackage.STANDARD_NODE: {
			...
			case BehaviortreePackage.COMPONENT: {
			...
			case BehaviortreePackage.CT_EDGE: {
				CTEdge ctEdge = (CTEdge)theEObject;
				T result = caseCTEdge(ctEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviortreePackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviortreePackage.LIBRARY: {
			...
			case BehaviortreePackage.LINK: {
				Link link = (Link)theEObject;
				T result = caseLink(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviortreePackage.ALTERNATIVE_CLASS: {
