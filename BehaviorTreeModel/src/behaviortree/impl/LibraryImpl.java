...
public class LibraryImpl extends EObjectImpl implements Library {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.LIBRARY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.LIBRARY__NAME, oldName, name));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.LIBRARY__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.LIBRARY__NAME:
				return getName();
