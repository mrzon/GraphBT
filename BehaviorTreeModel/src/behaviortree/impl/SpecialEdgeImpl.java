 ...
 * <ul>
 *   <li>{@link behaviortree.impl.SpecialEdgeImpl#getType <em>Type</em>}</li>
 *   <li>{@link behaviortree.impl.SpecialEdgeImpl#getDestination <em>Destination</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecialEdgeImpl extends EObjectImpl implements SpecialEdge {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.SPECIAL_EDGE;
	}
	...
	public void setType(SpecialEdgeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.SPECIAL_EDGE__TYPE, oldType, type));
	}
	...
	public void setDestination(int newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.SPECIAL_EDGE__DESTINATION, oldDestination, destination));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.SPECIAL_EDGE__TYPE:
				return getType();
			case BehaviortreePackage.SPECIAL_EDGE__DESTINATION:
