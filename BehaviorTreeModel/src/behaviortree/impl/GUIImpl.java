 ...
 * <ul>
 *   <li>{@link behaviortree.impl.GUIImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link behaviortree.impl.GUIImpl#getCodeImplementation <em>Code Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GUIImpl extends EObjectImpl implements GUI {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.GUI;
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.GUI__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setCodeImplementation(String newCodeImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.GUI__CODE_IMPLEMENTATION, oldCodeImplementation, codeImplementation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.GUI__IDENTIFIER:
				return getIdentifier();
			case BehaviortreePackage.GUI__CODE_IMPLEMENTATION:
