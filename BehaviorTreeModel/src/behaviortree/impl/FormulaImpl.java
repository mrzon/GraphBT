 ...
 * <ul>
 *   <li>{@link behaviortree.impl.FormulaImpl#getFormulaName <em>Formula Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FormulaImpl extends EObjectImpl implements Formula {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.FORMULA;
	}
	...
	public void setFormulaName(String newFormulaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.FORMULA__FORMULA_NAME, oldFormulaName, formulaName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.FORMULA__FORMULA_NAME:
