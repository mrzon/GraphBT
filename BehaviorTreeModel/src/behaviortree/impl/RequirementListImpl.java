 ...
 * <ul>
 *   <li>{@link behaviortree.impl.RequirementListImpl#getRequirements <em>Requirements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequirementListImpl extends EObjectImpl implements RequirementList {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.REQUIREMENT_LIST;
	}
	...
	public EList<Requirement> getRequirements() {
		if (requirements == null) {
			requirements = new EObjectContainmentEList<Requirement>(Requirement.class, this, BehaviortreePackage.REQUIREMENT_LIST__REQUIREMENTS);
		}
		return requirements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviortreePackage.REQUIREMENT_LIST__REQUIREMENTS:
