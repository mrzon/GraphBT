 ...
 * <ul>
 *   <li>{@link behaviortree.impl.OperatorClassImpl#getOperatorLiteral <em>Operator Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorClassImpl extends EObjectImpl implements OperatorClass {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.OPERATOR_CLASS;
	}
	...
	public void setOperatorLiteral(String newOperatorLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.OPERATOR_CLASS__OPERATOR_LITERAL, oldOperatorLiteral, operatorLiteral));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.OPERATOR_CLASS__OPERATOR_LITERAL:
