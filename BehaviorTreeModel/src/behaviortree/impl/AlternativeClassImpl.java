 ...
 * <ul>
 *   <li>{@link behaviortree.impl.AlternativeClassImpl#getAlternativeAttribute <em>Alternative Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlternativeClassImpl extends EObjectImpl implements AlternativeClass {
	...
	protected EClass eStaticClass() {
		return BehaviortreePackage.Literals.ALTERNATIVE_CLASS;
	}
	...
	public void setAlternativeAttribute(String newAlternativeAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviortreePackage.ALTERNATIVE_CLASS__ALTERNATIVE_ATTRIBUTE, oldAlternativeAttribute, alternativeAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviortreePackage.ALTERNATIVE_CLASS__ALTERNATIVE_ATTRIBUTE:
