...
public class DirectEditBehaviorGraphBtFeature extends AbstractDirectEditingFeature {

	public DirectEditBehaviorGraphBtFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void setValue(String value, IDirectEditingContext context) {
		...
		try {
			...
			if(!GraphBTUtil.isExist(rs, URI.createURI("bt.component.behavior." + value)))
			{
				...
				System.out.println("check direct edit behavior");
