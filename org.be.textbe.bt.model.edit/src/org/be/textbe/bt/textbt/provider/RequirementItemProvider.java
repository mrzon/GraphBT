...
/**
 * This is the item provider adapter for a {@link org.be.textbe.bt.textbt.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_ref_feature", "_UI_Requirement_type"),
				 TextbtPackage.Literals.REQUIREMENT__REF,
				 true,
				 false,
				 false,
	...
	protected void addValPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_val_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_val_feature", "_UI_Requirement_type"),
				 TextbtPackage.Literals.REQUIREMENT__VAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Requirement)object).getRef();
