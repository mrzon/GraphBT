...
/**
 * This is the item provider adapter for a {@link org.be.textbe.bt.textbt.AtomicNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicNodeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TextbtPackage.Literals.ATOMIC_NODE__CHILD_NODE);
		}
	...
	public String getText(Object object) {
		String label = ((AtomicNode)object).getComponentRef();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TextbtPackage.Literals.ATOMIC_NODE__CHILD_NODE,
				 TextbtFactory.eINSTANCE.createSequentialNode()));

		newChildDescriptors.add
			(createChildParameter
				(TextbtPackage.Literals.ATOMIC_NODE__CHILD_NODE,
				 TextbtFactory.eINSTANCE.createAtomicNode()));

		newChildDescriptors.add
			(createChildParameter
				(TextbtPackage.Literals.ATOMIC_NODE__CHILD_NODE,
				 TextbtFactory.eINSTANCE.createParallelBlock()));

		newChildDescriptors.add
			(createChildParameter
				(TextbtPackage.Literals.ATOMIC_NODE__CHILD_NODE,
				 TextbtFactory.eINSTANCE.createAlternativeBlock()));
	}
